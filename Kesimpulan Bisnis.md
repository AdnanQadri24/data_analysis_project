...
## 📌 Ringkasan Eksekutif
Analisis ini bertujuan untuk mengevaluasi performa penjualan *Coffee Shop* berdasarkan tren bulanan, pola transaksi harian dan jam operasional, serta preferensi kategori produk pelanggan. Hasil analisis ini memberikan wawasan strategis untuk mengoptimalkan pendapatan, manajemen stok, dan efisiensi operasional.
...
1. **Optimalisasi *Peak Hours* Pagi (08.00 - 10.00)**
...
2. **Strategi Mendorong Penjualan Akhir Pekan (Khususnya Sabtu)**
...
3. **Evaluasi & Pengelolaan Produk *Slow-Moving***
...
4. **Upselling Produk Pendamping (*Bakery*)**
